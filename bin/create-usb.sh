...
for i in  $(ls -d /media/michl/PR_*); do
    ...
    rsync -av --human-readable --exclude='.git*' --exclude='.ipynb_checkpoints' --exclude='.cache' --exclude='__pycache__' --exclude='python.itcarlow.ie' --ignore-errors --delete ./downloads/ ${i}/downloads/
